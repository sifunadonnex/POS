...
1. Add the supplier ledger and purchase reconciliation/reporting endpoints; supplier creation/listing is still not an API capability.
2. Add explicit manager review and defect-flag handling for incoming stock quality issues, plus configurable low-stock thresholds.
